...
$(document).ready(function() {
  ...
  $("#Faechersammlungen #q.field").keyup(function() {
    ...
    if ($("#Faechersammlungen #q.field").val().length >= 3) {
      ...
      $.ajax({
        url: window.location.host + '/?eID=subtabs_subjects&faechersammlungen[suche]=' + filter + '&faechersammlungen[language]=' + sys_language_uid
      }).complete(function(data) {
        $("#Faechersammlungen .tabsContentPlus").html(data.responseText);
        return $(".tx-subtabs-fach").css("display", "inline");
      });
      if (arr.length > 0) {
